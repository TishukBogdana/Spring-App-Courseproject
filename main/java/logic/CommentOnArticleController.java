...
public class CommentOnArticleController {
    ...
    public void add(@Nullable @RequestParam(value = "reply") int id_com, @RequestParam(value = "author") String login, @RequestParam(value = "article")int id_art, @RequestParam(value = "content") String content){
