...
public class CommentOnNewsController {
    ...
    public void add(@Nullable @RequestParam(value = "reply") int id_com, @RequestParam(value = "author") String login, @RequestParam(value = "news")int id_news, @RequestParam(value = "content") String content){
