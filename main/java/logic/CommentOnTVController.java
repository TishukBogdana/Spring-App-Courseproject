...
@RequestMapping("/tvcom/upd")
   ...
   public void addComment(@Nullable @RequestParam(value = "reply") int com, @Nullable @RequestParam(value = "author")String login, @RequestParam(value = "content") String content){
